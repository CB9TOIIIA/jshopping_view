...
<?php if ($product->label_id){?>
	...
	<div class="product-inner-boxshadow">
		...
		<div class="image">
			...
			<div class="image-overlay">
				<div class="hover-links clearfix">
					<a href="<?php print $product->product_link?>"></a>
				</div>			
			</div>
			<?php }?>        
        ...
        <tr>
            ...
            <td class="buttons">            
                <input type="submit" class="button button_buy_from_our_work" value="<?php print _JSHOP_ADD_TO_CART?>" <?php //onclick="jQuery('#to').val('cart');" ?> />
            </td>
